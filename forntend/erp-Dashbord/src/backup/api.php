...
//     // add it to student assignments
//     // Route::get('/asi/{student_id}/{clas_id}','getassignment');

//     // view assignment submissions
//     // Route::get('/asisubs/{ass_id}','getAssignmentSubmissions');

//     // teacher download students assignment
//     // Route::get('teacher/downloadStudentAsssignment/{ass_id}/{student_id}','download_student_assignment_submissions');

//     // teacher update student submmision status
//     // Route::post('teacher/assignmentStatus','assignment_status');
